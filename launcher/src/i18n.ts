...
const tr: Record<keyof typeof en, string> = {
  ...
  skillAttachmentsBody: "Açıkça seçilen Codex skill'lerini satır içi talimat yerine adlandırılmış metin dosyaları olarak yükler. Diğer skill'ler araçlar üzerinden okunmaya devam eder. Varsayılan kapalıdır ve görsellerle aynı ek sınırını paylaşır.",
