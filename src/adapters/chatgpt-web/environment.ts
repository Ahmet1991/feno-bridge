...
/**
 * A steering turn can refer to a same-turn environment declaration preceding its active
 * instruction. The thread store must compare the claim with the canonical native rollout.
 */
